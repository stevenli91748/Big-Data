...
* [Kubernetes权威指南：企业级容器云实战](https://weread.qq.com/web/reader/58632870721e42b15869de9)
...
* [【新版】K8S+DevOps云原生全栈技术：基于世界500强的高薪实战Kubernetes课程](https://edu.51cto.com/course/27936.html)
 

# 博客

[阿里巴巴 知行动手实验室](https://start.aliyun.com/)|[kubernetes 从入门到实践](https://www.kancloud.cn/huyipow/kubernetes)|[k8s原理与实践](https://www.kancloud.cn/pm1028/kubenetes)|[基于 Kubernetes 的微服务项目设计与实现](https://mp.weixin.qq.com/s/O3JdCk9MM2Slpr4xsnZipA)|
---|---|---|---|
...
**负载均衡**：采用 Kubernetes Service 本身的负载均衡能力实现（就是 DNS 负载均衡），可以不再需要 Ribbon 这样的客户端负载均衡了。Spring Cloud Kubernetes 从 1.1.2 开始也已经移除了对 Ribbon 的适
配支持，也（暂时）没有对其代替品 Spring Cloud LoadBalancer 提供适配。
