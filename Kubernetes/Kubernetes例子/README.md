# 目录
* [项目完整例子](#项目完整例子)
  * [Kubernetes部署例子](#Kubernetes部署例子)
  * [Kubernetes高可用](#Kubernetes高可用)
  * [Kubernetes通信](#Kubernetes通信)
...
* [k8s高可用部署：keepalived + haproxy----生产环境所用的部署架构](https://www.kubernetes.org.cn/6964.html)
